...
export default function Dashboard() {
  ...
  const pieData = [
    ...
    { name: 'Proforma', value: stats?.invoicesByType?.proforma || 0, color: '#F97316' },
            ...
            >
              <div className="flex items-center justify-between gap-4">
                <div className="flex-1 min-w-0">
                  ...
                  <p className={`text-2xl lg:text-3xl font-bold bg-gradient-to-r ${card.color} bg-clip-text text-transparent break-words`}>
                    {card.value}
                  </p>
                </div>
                <div className={`flex-shrink-0 p-3 rounded-lg bg-gradient-to-br ${card.color} bg-opacity-10`}>
